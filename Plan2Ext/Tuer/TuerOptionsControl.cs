...
namespace Plan2Ext.Tuer
{
    public partial class TuerOptionsControl : UserControl
    {
        ...
        private void txtWidth_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                Autodesk.AutoCAD.ApplicationServices.Application.ShowAlertDialog(string.Format(CultureInfo.CurrentCulture, "Fehler in TuerOptions aufgetreten! {0}", ex.Message));
            }
            finally
            {
