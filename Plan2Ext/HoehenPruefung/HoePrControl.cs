    ...
    public partial class HoePrControl : UserControl
    {
        ...
        private void btnCheckFb_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument.SendStringToExecute("Plan2HoePrCheckFb ", true, false, false);
            }
            catch (Exception ex)
            {
                Autodesk.AutoCAD.ApplicationServices.Application.ShowAlertDialog(ex.Message);
        ...
        private void btnSelPolygonLayer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument.SendStringToExecute("Plan2HoePrSelPolygonLayer ", true, false, false);
            }
            catch (Exception ex)
            {
                Autodesk.AutoCAD.ApplicationServices.Application.ShowAlertDialog(ex.Message);
        ...
        private void btnResetCheck_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument.SendStringToExecute("Plan2HoePrResetCheck ", true, false, false);
            }
            catch (Exception ex)
            {
                Autodesk.AutoCAD.ApplicationServices.Application.ShowAlertDialog(ex.Message);
